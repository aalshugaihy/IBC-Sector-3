...
بعد إنشاء الخدمة، ادخل إلى **Environment** وأضف:

| المتغير | القيمة المقترحة | متى يكون مطلوباً |
|---------|----------------|------------------|
| `GEMINI_API_KEY` | مفتاحك من [aistudio.google.com](https://aistudio.google.com/apikey) | لتفعيل المحادثة والتقارير بالذكاء الاصطناعي |
